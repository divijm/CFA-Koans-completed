...
class AboutRegularExpressions < Neo::Koan
  ...
  # It grabs more data then you need. Too much and may corrupt your info.
  # ------------------------------------------------------------------
  ...
  # maybe [0123456789]+ is the same as \d+ and it looks for any digits in the string
  ...
  # we'll get start returned because start is found at the start,
  # and next we get nil, because ruby can't find end in start. Make sense?
